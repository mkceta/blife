...
const formSchema = z.object({
    ...
    location_area: z.string().optional(), // Deprecated but kept for schema compatibility if needed
                                        ...
                                        {field.value ? (
                                            <div className="flex items-center justify-between bg-primary/10 px-4 py-3 rounded-xl border border-primary/20">
                                                ...
                                                <Button
                                                    ...
                                                    className="h-auto p-1 hover:bg-destructive/10 text-muted-foreground hover:text-destructive"
                                                >
                                                    Borrar
                                                </Button>
                                            </div>
