...
import { Award, ShieldCheck, Trophy, Lock, HelpCircle, Shield, Store, BookOpen, Cpu, Shirt, Star, Rocket, Crown, Key } from 'lucide-react'
        ...
        if (open) {
            ...
            Promise.all([
                ...
                if (userBadgesRes.data) {
                    setUserBadges(new Set(userBadgesRes.data.map((ub: any) => ub.badge_id)))
                }
                setLoading(false)
            })
        }
