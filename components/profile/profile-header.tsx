                        ...
                        <div className="pt-4 border-t border-dashed border-border/60 mt-4">
                            ...
                            <div className="flex flex-wrap justify-center md:justify-start gap-4">
                                {userBadges.map((badge) => (
                                    <div key={badge.id} className="relative group flex items-center gap-2 p-1 pr-3 bg-gradient-to-br from-background to-muted/30 rounded-full border border-border hover:border-primary/40 shadow-sm hover:shadow-md transition-all duration-300 cursor-default select-none">
