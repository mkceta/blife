...
export const FlatCard = memo(function FlatCard({ flat, currentUserId, priority = false }: FlatCardProps) {
    ...
    }, [currentUserId, flat.id, flat.user_id, router, supabase])
    ...
    }, [currentUserId, flat.id, router, supabase])
