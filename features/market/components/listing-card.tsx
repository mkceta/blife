...
// Photo type for proper typing
interface Photo {
    url: string
    thumb_url?: string
}

// Supabase client singleton - created once at module level
...
export const ListingCard = memo(function ListingCard({
    ...
    // Handle photos being null or empty with proper typing
    const photos = listing.photos as Photo[] | null
    ...
    const handleDelete = useCallback(async () => {
        ...
        queryClient.setQueriesData({ queryKey: ['market-listings'] }, (oldData: unknown) => {
            ...
            if (Array.isArray(oldData)) {
                return oldData.filter((item: { id: string }) => item.id !== listing.id)
            }
            return oldData
        })
            ...
            <div className="flex flex-col gap-0.5 px-0.5 mt-2">
                ...
                <div className="hidden md:block">
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        >
                            {listing.user?.alias_inst || 'anonimo'}
                        </Link>
                    </div>
